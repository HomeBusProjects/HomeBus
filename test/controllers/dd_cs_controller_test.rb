...
if false
  ...
  test "should create ddc" do
    assert_difference('Ddc.count') do
      post ddcs_url, params: { ddc: { description: @ddc.description, name: @ddc.name, reference_url: @ddc.reference_url } }
    end
  ...
  test "should update ddc" do
    patch ddc_url(@ddc), params: { ddc: { description: @ddc.description, name: @ddc.name, reference_url: @ddc.reference_url } }
