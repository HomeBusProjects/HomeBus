...
class SpacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create space" do
    assert_difference('Space.count') do
      post spaces_url, params: { space: { friendly_name: @space.friendly_name, interior: @space.interior } }
    end
  ...
  test "should update space" do
    patch space_url(@space), params: { space: { friendly_name: @space.friendly_name, interior: @space.interior } }
