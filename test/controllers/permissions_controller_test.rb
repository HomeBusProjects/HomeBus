    ...
    test 'should create permission' do
      assert_difference('Permission.count') do
        post permissions_url,
             params: { permission: { consumes: @permission.consumes, ddc_id: @permission.ddc_id, device_id: @permission.device_id,
                                     network_id: @permission.network_id, publishes: @permission.publishes } }
      end
