  ...
  if false
    ...
    test 'should create public_network' do
      assert_difference('PublicNetwork.count') do
        post public_networks_url,
             params: { public_network: { active: @public_network.active, description: @public_network.description,
                                         network_id: @public_network.network_id, title: @public_network.title } }
      end
    ...
    test 'should update public_network' do
      patch public_network_url(@public_network),
            params: { public_network: { active: @public_network.active, description: @public_network.description,
                                        network_id: @public_network.network_id, title: @public_network.title } }
