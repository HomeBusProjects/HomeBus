  ...
  if false
    ...
    test 'should create public_device' do
      assert_difference('PublicDevice.count') do
        post public_devices_url,
             params: { public_device: { active: @public_device.active, description: @public_device.description,
                                        device_id: @public_device.device_id, title: @public_device.title } }
      end
    ...
    test 'should update public_device' do
      patch public_device_url(@public_device),
            params: { public_device: { active: @public_device.active, description: @public_device.description,
                                       device_id: @public_device.device_id, title: @public_device.title } }
