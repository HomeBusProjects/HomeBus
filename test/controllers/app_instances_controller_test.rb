  ...
  if false
    ...
    test 'should create app_instance' do
      assert_difference('AppInstance.count') do
        post app_instances_url,
             params: { app_instance: { app_id: @app_instance.app_id, parameters: @app_instance.parameters,
                                       public_key: @app_instance.public_key, user_id: @app_instance.user_id } }
      end
    ...
    test 'should update app_instance' do
      patch app_instance_url(@app_instance),
            params: { app_instance: { app_id: @app_instance.app_id, parameters: @app_instance.parameters,
                                      public_key: @app_instance.public_key, user_id: @app_instance.user_id } }
