...
ActiveRecord::Schema.define(version: 20_200_930_060_413) do
  ...
  create_table 'mosquitto_accounts', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[enabled provision_request_id], name: 'index_mosquitto_accounts_on_enabled_and_provision_request_id',
                                              unique: true
    t.index %w[id enabled], name: 'index_mosquitto_accounts_on_id_and_enabled'
